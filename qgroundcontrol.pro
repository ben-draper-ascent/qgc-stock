...
QGC_APP_NAME        = "Ascent Aerosystems QGC"
QGC_ORG_NAME        = "Ascent Aerosystems"
QGC_ORG_DOMAIN      = "ascentaerosystems.com"
QGC_APP_DESCRIPTION = "Open source ground control app modified by Ascent Aerosystems"
QGC_APP_COPYRIGHT   = "Copyright (C) 2019 QGroundControl Development Team. All rights reserved."

WindowsBuild {
    QGC_INSTALLER_SCRIPT        = "$$SOURCE_DIR\\deploy\\windows\\nullsoft_installer.nsi"
    QGC_INSTALLER_ICON          = "$$SOURCE_DIR\\custom\\res\\Images\\AscentLogo.ico"
