...
Item {
    ...
    FlyViewToolStrip {
        ...
        onDisplayPreFlightChecklist: mainWindow.displayChecklist()
        //onDisplayPreFlightChecklist: preFlightChecklistPopup == nullptr ? preFlightChecklistPopup.createObject(mainWindow).open() : preFlightChecklistPopup.open()
